...
template <typename T_seq_, bool is_canonical_, bool clean_seq_> class Minimizer_Iterator;
...
class Lmer_Tuple
{
    ...
    template <typename T_seq_, bool is_canonical_, bool clean_seq_> friend class Minimizer_Iterator;
